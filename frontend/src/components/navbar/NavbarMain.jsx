					...
					<div className="flex gap-3 items-center">
						{user?.is_admin ? (
							<div className="dropdown dropdown-end">
								...
								>
									<li className="border-b border-primary flex gap-1 pb-1">
									...
									<li className="border-b border-primary flex gap-1 pt-1 pb-1">
										<div className="text-neutral">
											<svg
												xmlns="http://www.w3.org/2000/svg"
												fill="none"
											...
											<NavLink to="/editcontent">Edit Content</NavLink>
										</div>
									</li>
